...
<img class="lefticon" title="iBin icon" src="{{site.baseurl}}/wp-content/uploads/iBin-icon.png" alt="" width="48" height="48" />
...
<img class="borderimg centered" title="ibin löschen abfrage" src="{{site.baseurl}}/wp-content/uploads/ibin-loeschen-abfrage.png" alt="" width="430" height="147" />
...
<img class="borderimg centered" title="ibin gelöschte dateien" src="{{site.baseurl}}/wp-content/uploads/ibin-geloeschte-dateien.png" alt="" width="463" height="310" />
