...
<h3>P^2 Config Tool - Mein erstes Gtk-Programm</h3>
...
<img src="http://ganz-sicher.net/blog/wp-content/uploads/1.jpg" alt="" width="486" height="268" />

&nbsp;

<img src="http://ganz-sicher.net/blog/wp-content/uploads/2.jpg" alt="" width="448" height="1058" />
...
&nbsp;
<h3>Gnome 3 / Gnome Shell Networkmanager: "VPN-Icon-Workaround"</h3>
...
<img src="http://ganz-sicher.net/blog/wp-content/uploads/2.png" alt="" width="269" height="133" />

Hier der Code für die extension.js-Datei:
<blockquote>const Panel = imports.ui.panel;
function main() {
let i = Panel.STANDARD_TRAY_ICON_
ORDER.indexOf('network');
if (i &gt;= 0) {
Panel.STANDARD_TRAY_ICON_
ORDER.splice(i,1);
}
